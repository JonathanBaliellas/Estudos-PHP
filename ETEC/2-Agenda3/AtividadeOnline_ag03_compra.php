...
<body>
    ...
    <form class="w3-container" method="post" action="AtividadeOnline_ag03_action.php">
        ...
        <input class="w3-input w3-border w3-light-grey" name="txtValorCompra" type="number" min="0" step="0.01">
