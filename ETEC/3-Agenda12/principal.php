...
<body class="w3-light-grey">
    ...
    <main class="w3-padding-large" id="main">
        ...
        <section class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width: 70%;">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input type="date" class="w3-input w3-border w3-round-large" name="txtData" placeholder="" value="">
                    </div>
                </div>
                <div class="w3-row w3-section">
                    <div class="w3-col" style="width: 11%;">
        ...
        <section class="w3-padding-128 w3-content w3-text-grey" id="formacao">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input type="text" name="txtDescFA" class="w3-input w3-border w3-round-large" placeholder="Descrição: Ex.: Técnico em Desenvolvimento de Sistemas - Centro Paula Souza">
                    </div>
                </div>
                <div class="w3-row w3-section">
                    <div class="w3-center">
        ...
        <section class="w3-padding-128 w3-content w3-text-grey" id="outrasFormacoes">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin">
                ...
                <div class="w3-row w3-section">
                    <div class="w3-row w3-section w3-col" style="width: 45%;">
                        ...
                        <div class="w3-rest">
                            <input type="date" name="txtInicioOF" class="w3-input w3-border w3-round-large">
                        </div>
                    </div>
                    <div class="w3-row w3-section w3-rest">
                        <div class="w3-col" style="width: 13%;">
                        ...
                        <div class="w3-rest">
                            <input type="date" name="txtFimOF" class="w3-input w3-border w3-round-large">
                        </div>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input type="text" name="txtDescEP" class="w3-input w3-border w3-round-large" placeholder="Descrição: Ex.: Técnico em Desenvolvimento de Sistemas - Centro Paula Souza">
                    </div>
                </div>
                <div class="w3-row w3-section">
                    <div class="w3-center">
